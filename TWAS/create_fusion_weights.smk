...
out_folder = "/sc/arion/projects/als-omics/QTL/NYGC_Freeze02_European_Feb2020/downstream-QTL/TWAS/results/"
# hardcoded inputs
...
rule split_vcf:
    ...
    run:
        for chromo in range(1,23):
            shell("ml plink; plink --vcf {input} --chr {chromo} --make-bed --out {prefix}/geno/{data_code}.{chromo} ")
